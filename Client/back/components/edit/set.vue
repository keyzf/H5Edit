				...
				<div class="item">
					...
					<div class="main">
						<div class="kind">
							...
							<input type="text" placeholder="请输入作品标题" data-type="title" :value="title"></input>
						</div>
						<div class="kind">
		...
		vuex: {
			getters: {
				...
				about: function(state) {
					return state.workData.about;
				},
				setConfig: function(state) {
					return state.workData.setConfig;
				}
			},
			actions: {
				alert: actions.alert
...
<style>
	...
	.set_con .left .item .thumbnail img {
		display: block;
		width: 218px;
		height: 218px;
	}
	...
	.set_con .left .item .thumbnail input {
		display: block;
		position: absolute;
		top: 0;
		left: 0;
	...
	.set_con .left .item .thumbnail span:hover {
		background: #fff;
		color: #01d7b2;
	}
	.set_con .left .item .tips {
		font-size: 12px;
		line-height: 24px;
		color: #76838f;
		display: block;
	...
	.set_con .left .item.set_btn {
		width: 100%;
		font-size: 0;
		text-align: center;
	}
	.set_con .left .item.set_btn a{
	...
	.set_con .left .item.set_btn a:first-child {
		background: rgba(1,215,178,1);
	}
	.set_con .left .item.set_btn a:first-child:hover {
		background: rgba(1,215,178,0.7);
	}
	.set_con .left .item.set_btn a:last-child {
		background: rgba(8,161,239,1);
	}
	.set_con .left .item.set_btn a:last-child:hover {
	...
	.set_con .right .item .head {
		width: 100%;
		background: url('../../assets/img/basic_info_title.png') no-repeat;
		color: #fff;
		font-size: 12px;
		line-height: 20px;
		text-indent: 15px;
	}
	.set_con .right .item .main .kind {
		margin-top: 15px;
	}
	.set_con .right .item .main .kind label {
		font-size: 14px;
		color: #76838f;
		display: inline-block;
		width: 100px;
	...
	.set_con .right .item .main .kind label span {
		color: #01d7b2;
		position: absolute;
		font-size: 20px;
		left: -14px;
	...
	.set_con .right .item .main textarea {
		width: 270px;
		display: inline-block;
		vertical-align: top;
		padding: 0 10px;
